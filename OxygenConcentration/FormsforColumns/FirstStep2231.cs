...
{
    public partial class FirstStep2231 : Form
    {
        public FirstStep2231()
        {
            InitializeComponent();
        ...
        private void Calculatebutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double f = (a - b) / 24;  //Концентрация за сутки
        ...
        {// Очищаем предыдущие данные
            ...
            // Строим график для x от 1 до 24
            for (double x = 1; x <= 24; x += 1)
            {
                double y = a - f * x;
            ...
            chartArea.Position.Y = 20; // Отступ от верхнего края
